...
public static class WavUtility
{
	...
	public static int BlockSize_16Bit = 2;
	...
	public static int WriteBytesToMemoryStream (ref MemoryStream stream, byte[] bytes, string tag = "")
	{
	...
	public static int BytesPerSample (UInt16 bitDepth)
	{
		return bitDepth / 8;
	}

	public static int BlockSize (UInt16 bitDepth)
	{
		switch (bitDepth) {
		case 32:
